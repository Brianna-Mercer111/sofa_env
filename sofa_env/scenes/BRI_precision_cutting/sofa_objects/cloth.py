...
from sofa_env.scenes.BRI_precision_cutting.sofa_objects.cloth_cut import linear_cut
from sofa_env.scenes.BRI_precision_cutting.sofa_objects.grid_path_projection import GridPathProjection, RunningAxis
